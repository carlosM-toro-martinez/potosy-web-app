...
export const put = async (endpoint, payload, isFile = false) => request(endpoint, payload, 'PUT', isFile);

export const remove = async (endpoint, payload, isFile = false) => request(endpoint, payload, 'DELETE', isFile);