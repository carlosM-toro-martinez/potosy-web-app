...
const ImageTextComp = () => {
  ...
  const tourData = {
    ...
    title: '¿Sabías que?',
    description: 'Potosí celebra con júbilo que la “Festividad de San Bartolomé y San Ignacio de Loyola Ch’utillos” fue declarada como patrimonio inmaterial de la humanidad en la XVIII SESIÓN DEL Comité intergubernamental',
