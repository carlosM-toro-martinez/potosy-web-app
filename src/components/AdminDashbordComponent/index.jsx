          ...
          <Table sx={{ width: '50rem' }} className={clasess.table}>
            <TableHead>
              <TableRow sx={{
                ...
                <TableCell sx={{ color: 'black' }} className={clasess.row}>Detalles</TableCell>
                <TableCell sx={{ color: 'black' }} className={clasess.row}>Eliminar</TableCell>
                <TableCell sx={{ color: 'black' }} className={clasess.row}>Estado</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {!isLoading && !error ? data.map(item => (
                <TableRow key={item.business_id} sx={{ color: 'black' }}>
                  <TableCell sx={{ color: 'black', textTransform: 'capitalize' }}>{item?.name}</TableCell>
                  ...
                  <TableCell sx={{ color: 'black' }}>
                    <Button variant="contained" onClick={() => handleNavigate(item.business_id)} >
                      Ver_Mas
                    </Button>
                  </TableCell>
                  <TableCell sx={{ color: 'black' }}>
                    <Button color='error' variant="contained" startIcon={<DeleteIcon />} onClick={() => handleDelete(item.business_id)}>
                      Delete
                    </Button>
                  </TableCell>
